<!-- Factory Managers
Monitor overall factory performance
    ...
    <header class="main-header">
        <nav class="nav main-nav">
            <ul>
                ...
                <li><a href="machine.php">Manage Machine</a></li>           <!-- Create, update, and delete user accounts -->
                <li><a href="job.html">Assign Jobs</a></li>
